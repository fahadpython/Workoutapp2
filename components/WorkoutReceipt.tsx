...
import { Share2, RotateCcw, Barcode } from 'lucide-react';
...
const WorkoutReceipt: React.FC<Props> = ({ data, onClose }) => {
  ...
  return (
    <div className="min-h-screen bg-gym-900 flex flex-col items-center justify-center p-4">
       
       {/* RECEIPT CONTAINER */}
       <div className="bg-white text-black font-mono w-full max-w-sm shadow-2xl relative animate-in slide-in-from-bottom-10 duration-700 transform rotate-1 hover:rotate-0 transition-transform">
          
          {/* RIPPED TOP EDGE EFFECT (CSS Clip Path or simple SVG) */}
       ...
       {/* ACTIONS */}
       <div className="mt-8 flex gap-4 animate-in fade-in delay-500">
           <button 
             onClick={handleShare}
